    ...
    <!-- Input Mask JS
        ============================================ -->
    <script src="<?=base_url(); ?>assets/template/js/jasny-bootstrap.min.js"></script>
    <!-- icheck JS
        ============================================ -->
    ...
    <!-- rangle-slider JS
        ============================================ -->
    <script src="<?=base_url(); ?>assets/template/js/rangle-slider/jquery-ui-1.10.4.custom.min.js"></script>
    <script src="<?=base_url(); ?>assets/template/js/rangle-slider/jquery-ui-touch-punch.min.js"></script>
    <script src="<?=base_url(); ?>assets/template/js/rangle-slider/rangle-active.js"></script>
    ...
    <script type="text/javascript" src="<?=base_url(); ?>assets/template/js/session_waktu/jquery.idle.js"></script>
    <script src="<?=base_url(); ?>assets/template/js/font-awesome.js"></script>
